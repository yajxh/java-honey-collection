...
public class TestHotSwap {  
    ...
    public static void main(String args[]) throws MalformedURLException {  
        ...
        try {  
            URL[] urls = new URL[]{ new URL("file:///E:\\workspace\\workspace_java_tool\\workspace_sunny_project\\java-honey-collection\\jvm-sunny\\target\\classes\\") };
            HotSwapClassLoader c1 = new HotSwapClassLoader(urls, a.getClass().getClassLoader());  
            Class clazz = c1.load("com.sunny.jvm.classload.hotswap.A");  // 用hot swap重新加载类A
            ...
            System.out.println(aInstance.getClass() == a.getClass());
            System.out.println(aInstance instanceof  A);
